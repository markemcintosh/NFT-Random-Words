...
const CONTRACT_ADDRESS = "0x4a8bBE59dCbE65f61515c482cD0F61E7cDDC51c9";
    ...
    <div className="App">
      <div className="container">
        <div className="header-container">
          <p className="header gradient-text">Family Names NFT</p>
          <p className="sub-text">
            Unique Combos of all of our Names. You're Welcome.
          </p>
